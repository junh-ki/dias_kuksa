...
cmd = 'mosquitto_sub -d -h mqtt.bosch-iot-hub.com -p 8883 -u pc01@t20babfe7fb2840119f69e692f184127d -P junhyungki@123 --cafile iothub.crt -k 30 -t telemetry' # message to be continued...
os.system(cmd)
